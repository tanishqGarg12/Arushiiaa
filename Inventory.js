...
const InventoryApp = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="w-3/2 bg-white shadow-lg rounded-lg p-8">
                ...
                {items.map((item, index) => (
                  <tr key={index} className="border-b hover:bg-gray-50">
                    ...
                    <td className="border border-gray-300 p-3">
                      <button onClick={() => startEdit(index)} className="text-yellow-500 hover:underline">Edit</button>
                      <button onClick={() => deleteItem(index)} className="text-red-500 hover:underline ml-2">Delete</button>
                    </td>
                  </tr>
                ))}
              </tbody>
